...
from black_friday.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.blackfriday_estimator = BlackFridayEstimator(bucket_name=model_pusher_config.bucket_name,
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifact:
        ...
        try:
            ...
            self.blackfriday_estimator.save_model(from_file=self.model_evaluation_artifact.trained_model_path)
